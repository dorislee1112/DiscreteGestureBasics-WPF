        ...
        public GestureDetector(KinectSensor kinectSensor, GestureResultView gestureResultView)
        {
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                foreach (Gesture gesture in database.AvailableGestures)
                {
                    ...
                    if (gesture.Name.Equals(this.right_ProgressGestureName))
                    {
                        this.vgbFrameSource.AddGesture(gesture);
                    }
                    if (gesture.Name.Equals(this.left_ProgressGestureName))
                ...
                if (frame != null)
                {
                    ...
                    /*if (discreteResults != null)
                    {
                        ...
                        foreach (Gesture gesture in this.vgbFrameSource.Gestures)
                        {
                            ...
                            if ((gesture.Name.Equals(this.rightGestureName) || gesture.Name.Equals(this.leftGestureName)||gesture.Name.Equals(this.footGestureName) )&& gesture.GestureType == GestureType.Discrete)
                            {
